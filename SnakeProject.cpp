...
main()
{
    ...
    while(1)
    {
        ...
        setcolor(LIGHTBLUE);
        settextstyle(3,0,9);
        outtextxy(150,30," Snake ");
        setcolor(LIGHTCYAN);
        settextstyle(10,0,3); //this part prints menu again but inside while loop,because other functions will return here
...
void game()
{
    ...
    while(true)
        ...
        setfillstyle(SOLID_FILL,LIGHTGREEN);
         bar(snake_x[_size]-3,snake_y[_size]-3,snake_x[_size]+3,snake_y[_size]+3);
        ...
        sprintf(ara,"Best Score: %d",highscore);
        setcolor(LIGHTBLUE);
...
void dead()
{
     snake_x[500]={},snake_y[500]={},spd = 100;
     BONUS = false;
    checkdied = false;
    snake_size = 5;
    score = 0;
